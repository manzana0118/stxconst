window.onload = function() {
    ...
    let menu_data = [
    new MakeMenu('회사소개', 'http://manzana.dothome.co.kr/', '인사말, STX건설, 기업문화, STX건설연혁, 조직안내, 윤리경영, 안전·환경·품질경영, 찾아오시는 길', '#, #, #, #, #, #, #, #'),
    new MakeMenu('사업분야', 'http://manzana.dothome.co.kr/bbs/board.php?bo_table=business', '건축사업, 주택사업, 토목사업, 플랜트/공작기계사업, 해외사업', '#, #, #, #, #'),
    new MakeMenu('사회공헌', '#', '나눔의생각, 주요활동분야, 활동현황', '#, #, #'),
    new MakeMenu('홍보센터', '#', '홍보동영상, 홍보브로슈어, STX건설뉴스', '#, #, #'),
    new MakeMenu('고객지원', 'http://manzana.dothome.co.kr/bbs/board.php?bo_table=qa', '자주묻는질문, 고객문의', '#, #'),
